...
is( $file->Events->[0]->get_text,
    'C,A', 'and had the correct Text attribute' );
...
$file->add_dialogue(
  start => 30, end => '00:01:00', Text => '<Hola>', Name => 'Bill' );
$file->add_dialogue(
   start => '00:01:15', end => '00:01:20', Text => '<Como estas>', Name => 'Jill' );
...
$file =Video::Subtitle::OO::ASS::File->create_from_string($out);
my @g = $file->get_subtitles;
cmp_ok( $g[0]->start->second, '==', 11.830, 'sorting is numeric' );
